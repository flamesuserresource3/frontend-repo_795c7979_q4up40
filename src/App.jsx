            ...
            <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-6">
              <div className="bg-white/80 backdrop-blur rounded-xl border p-5">
                ...
                <ol className="list-decimal pl-5 text-sm text-gray-600 space-y-1">
                  ...
                  <li>Security memindai/mengetik kode dan menandai barang sebagai released.</li>
                </ol>
              </div>
              <div className="bg-white/80 backdrop-blur rounded-xl border p-5">
                ...
                <ul className="list-disc pl-5 text-sm text-gray-600 space-y-1">
                  ...
                  <li>User: ajukan izin, lihat status, cetak.</li>
                  <li>Pengawas: setujui/tolak pengajuan satu section.</li>
                  <li>Security: verifikasi kode dan rilis.</li>
                </ul>
              </div>
              <div className="bg-white/80 backdrop-blur rounded-xl border p-5">
